...
public class App {
    public static void man(String[] args ) throws EmailExcepton{
        ...
        channel.login("albertusadrian@students.ukdw.ac.id");
        ...
        channel.bagikanIde("#ISAT saat ini sedang menguji area resistance. Di sisi lain #TLKM sudah berhasil rebond");
        ...
        System.out.println("\n--------Skenarion Final: Print Informasi Akun--------");
        channel.printInfo();
    }
}

...
public class Phones {
    ...
    public Phones(String phoneName, String phoneCode, String companyCode, String androidCode) {
        ...
        setAndroidCode(androidCode);
    }

    public Phones(String phoneName, String phoneCode, String companyCode, String androidCode, int ramCapacity,
            int romCapacity, int cameraResolution, float screenSize) {
        setPhoneName(phoneName);
        setPhoneCode(phoneCode);
        setCompanyCode(companyCode);
        setAndroidCode(androidCode);
        setRamCapacity(ramCapacity);
        setRomCapacity(romCapacity);

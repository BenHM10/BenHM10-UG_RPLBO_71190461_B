...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (String compCode : Codes.COMPANYCODES) {
        ...
        if (choice.equalsIgnoreCase("y")) {
            ...
            for (String compCode : Codes.ANDROIDCODES) {
                System.out.println((index + 1) + ". " + compCode);
                index++;
            }
            System.out.print("Your choice (1/2/...): ");
    ...
    private static void checkSpecificationRequirement() {
        if (phone.getRamCapacity() == 0 && phone
                .getRomCapacity() == 0 && phone
                        .getScreenSize() == 0.0F
                && phone
            ...
            if (production.checkPhonesSpecification(phone.getAndroidCode())) {
                ...
                if (choice.equalsIgnoreCase("y")) {
                    ...
                    float productionRate = Float.parseFloat(scanner.nextLine());
        ...
        } else if (production.checkPhonesSpecification(phone.getAndroidCode(), phone.getRamCapacity(),
                phone.getRomCapacity())) {
            System.out.println("Starting To Production");
            System.out.println("Do you want to add production rate (faster production higher cost)");
            System.out.print("Yes (y) or No (n): ");
            String choice = scanner.nextLine();
    ...
    private static void addPhoneSpecification() {
        ...
        phone = new Phones(getPhoneName(), getPhoneCode(), getCompanyCode(), getAndroidCode(), getRamCapacity(),
                getRomCapacity(), getCameraResolution(), getScreenSize());
    }
